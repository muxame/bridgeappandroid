...
public class ViewAnimation extends Animation {
    ...
    private static final WeakHashMap<View, ViewAnimation> PROXIES = new WeakHashMap<View, ViewAnimation>();

    public static ViewAnimation wrap(View view) {
        ViewAnimation proxy = PROXIES.get(view);
        Animation animation = view.getAnimation();
        if (proxy == null || proxy != animation && animation != null) {
            proxy = new ViewAnimation(view);
