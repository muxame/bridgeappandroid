 ...
 */
public class Course_AdapterUpdateForUniversity extends RecyclerView.Adapter<Course_AdapterUpdateForUniversity.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View contactView = inflater.inflate(R.layout.item_cource_list, parent, false);
        ViewHolder viewHolder = new ViewHolder(ctx, contactView);
        return viewHolder;
    }

    public Course_AdapterUpdateForUniversity(Context context, List<CourseModel> listItems) {
        ...
        try {
            ...
            holder.tvApplyNow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ApplyModel.courseId = item.getId().toString();
                    onApplyClick();
                }
            });
