...
public class FiveHelpFragment extends BaseFragment {
    View view;
    ...
    public static Fragment newInstance(int i, String s) {
        FiveHelpFragment thirdHelpFragment = new FiveHelpFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_help_page_five, container,false);
