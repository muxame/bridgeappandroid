...
public class ThirdHelpFragment extends BaseFragment {
    View view;
    ...
    public static Fragment newInstance(int i, String s) {
        ThirdHelpFragment thirdHelpFragment = new ThirdHelpFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_third_page_help, container,false);
