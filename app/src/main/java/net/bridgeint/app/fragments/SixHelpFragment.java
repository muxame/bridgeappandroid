...
public class SixHelpFragment extends BaseFragment {
    View view;
    ...
    public static Fragment newInstance(int i, String s) {
        SixHelpFragment thirdHelpFragment = new SixHelpFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_help_page_six, container,false);
